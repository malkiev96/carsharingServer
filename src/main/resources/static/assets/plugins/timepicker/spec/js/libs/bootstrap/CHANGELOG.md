...
- Added variable `@navbarBrandColor` for the carbrand element in navbars, which defaults to `@navbarLinkColor`.
...
- Added support for `@navbarHeight` on the carbrand/project name and nav links for complete navbar height customization.
